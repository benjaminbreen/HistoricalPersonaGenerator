...
export const SCHOLARLY_SOURCES: Record<string, ScholarlySource> = {
  ...
  cunliffe2001: {
    ...
    kind: 'book',
    topic: 'archaeology',
    supports: 'The Atlantic seaboard from Iberia to the Hebrides as a single zone of contact, and the case for Celtic forming along it rather than arriving late from the Danube.',
    contested: 'The "Celtic from the West" chronology is a minority position; the central European origin remains the textbook account.',
  },
  kristiansen2005: {
    id: 'kristiansen2005',
    authors: 'Kristian Kristiansen & Thomas B. Larsson',
    year: 2005,
    title: 'The Rise of Bronze Age Society: Travels, Transmissions and Transformations',
    venue: 'Cambridge University Press',
    kind: 'book',
    topic: 'archaeology',
    supports: 'Continuity of the Nordic Bronze Age into the societies that later speak Germanic, and the long-distance contacts along which second-millennium languages spread.',
  },
  deHoz2010: {
    id: 'deHoz2010',
    authors: 'Javier de Hoz',
    year: 2010,
    title: 'Historia lingüística de la Península Ibérica en la Antigüedad',
    venue: 'Consejo Superior de Investigaciones Científicas',
    kind: 'book',
    topic: 'historical-linguistics',
    supports: 'The Palaeohispanic languages — Iberian, Tartessian, Lusitanian, Celtiberian — and which of them are Indo-European.',
    contested: 'Whether Tartessian is Celtic (Koch) or non-Indo-European (de Hoz, and most others) is unsettled.',
  },
  ventrisChadwick1973: {
    id: 'ventrisChadwick1973',
    authors: 'Michael Ventris & John Chadwick',
    year: 1973,
    title: 'Documents in Mycenaean Greek',
    venue: 'Cambridge University Press, 2nd edition',
    kind: 'book',
    topic: 'historical-linguistics',
    supports: 'Linear B as Greek, and so the earliest date from which Greek in Greece is recorded rather than reconstructed.',
  },
  janhunen2009: {
    id: 'janhunen2009',
